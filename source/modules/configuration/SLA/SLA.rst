...
Les SLAs sont associables aux tickets via le moteur de règles des tickets (voir :doc:`Règles métier pour les tickets </modules/administration/rules/ticketbusinessrules>`).  L'association du SLA au ticket permet le calcul automatique de sa date d'échéance. Plusieurs SLAs peuvent ainsi être définis et affectés suivant des critères précis.
...
* :doc:`Add a SLA </Les_différentes_actions/creer_un_nouvel_objet>`
* :doc:`Display a SLA </Les_différentes_actions/visualiser_un_objet>`
* :doc:`Modify a SLA </Les_différentes_actions/modifier_un_objet>`
* :doc:`Delete a SLA </Les_différentes_actions/supprimer_un_objet>`
